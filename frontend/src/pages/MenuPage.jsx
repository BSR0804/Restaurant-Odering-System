...
const MenuPage = ({ cart, addToCart, removeFromCart, tableNumber, prefetchedMenu }) => {
  ...
  return (
    <div className="screen">
      <div className="container" style={{ position: 'absolute', top: '60px', left: '0', right: '0', zIndex: 100, pointerEvents: 'none' }}>
         <div style={{ pointerEvents: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <button onClick={() => navigate('/')} className="btn-ghost" style={{ padding: '8px 16px', borderRadius: '99px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', marginLeft: '0px' }}>
